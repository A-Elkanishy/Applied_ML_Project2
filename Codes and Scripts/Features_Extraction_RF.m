...
TJ3=csvread('hf-adv-discovery.csv',Rs,0,[Rs,0,Re,2]);
time = TJ3(:, 1);
CH1 = TJ3(:, 3);
...
HF_Adv_RF = table(transpose(Area),transpose(Puls),transpose(Peak),categorical(Mode),categorical(Device));
HF_Adv_RF.Properties.VariableNames = {'Area','Puls','Peak','Mode','profile'};
